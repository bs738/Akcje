module.exports = {
	...
	subtitle: function (data) {
		const message = ['Temp Variable', 'Server Variable', 'Global Variable'];
		const info = ['Embed Fields', 'Embed Footer', 'Embed Description', 'Embed Image URL', 'Embed Thumbnail URL', 'Embed Color', 'Embed Author Name', 'Embed Author Icon URL', 'Embed Title', 'Embed URL', 'All'];
...
<div>
	<div style="padding-top: 8px; width: 70%;">
		...
		<select id="info" class="round">
			<option value="1">Embed Fields</option>
			<option value="2">Embed Footer</option>
			<option value="3">Embed Description</option>
			<option value="4">Embed Image URL</option>
			<option value="5">Embed Thumbnail URL</option>
			<option value="6">Embed Color</option>
			<option value="7">Embed Author Name</option>
			<option value="8">Embed Author Icon URL</option>
			<option value="9">Embed Title</option>
			<option value="10">Embed URL</option>
